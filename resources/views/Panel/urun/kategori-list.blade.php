			...
			<tbody>
				...
				@foreach($kategoriler as $kategori)
					...
					<tr>
						...
						<td>
							<a href="{{ route('panel.urun.kategori.duzenle', ['slug' => $kategori->slug]) }}" class="btn btn-primary" data-toggle="tooltip" data-bs-placement="bottom" title="Düzenle">
...
Swal.fire({
		type: "warning",               
		text: "Kategori ve bağlı bütün ürünler silinecek, devam edilsin mi?",          
	...
	if (result.value) {
		...
		$.ajax({
			type        : "post",
			url         : "{{ route('panel.urun.kategori.sil') }}",
			data        : {id:id},
