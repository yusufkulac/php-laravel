...
<section class="sayfa-icerik-kapsayici px-3">
	...
	<form id="urunKategoriEkleForm" enctype="multipart/form-data">
		...
		<div class="resim-ekle-wrap my-3 font-weight-bold" style="font-size: 16px">
			<i class="fas fa-images"></i>&nbsp;TANITIM RESMİ EKLE
		</div> 
...
$(function(){
	...
	//haber Ekle --------------------------------------------------------------
    $("#urunKategoriEkleForm").submit(function(e){
        e.preventDefault();
        ...
        if(kategori_adi <= 0){
            ...
            $.ajax({
                type        : "post",
                url         : "{{ route('panel.urun.kategori.ekle.post') }}",
                data        : form_data,
                contentType : false,            
                processData : false,            
                dataType    :'json',
