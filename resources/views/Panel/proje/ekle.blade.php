...
<section class="sayfa-icerik-kapsayici px-3">
	...
	<form id="projeEkleForm" enctype="multipart/form-data">
		...
		<div class="tab-content" id="pills-tabContent">
			...
			<div class="tab-pane fade show active" id="pills-bilgi" role="tabpanel" aria-labelledby="pills-bilgi-tab">
				...
				<div class="form-group my-2">
					...
					<input type="text" name="isveren" class="form-control">
				</div>
				...
				<div class="form-group my-2">
					...
					<input type="text" name="hizmet_alani" class="form-control">
				</div>

				<div class="row form-group my-2">
					<div class="col-sm-6">
						<label for="">Başlama Tarihi :</label>
						<input type="text" name="baslama_tarihi" class="form-control">
					</div>
					<div class="col-sm-6">
						<label for="">Bitiş Tarihi :</label>
						<input type="text" name="bitis_tarihi" class="form-control">
					</div>			
				</div>
				...
				<div class="form-group my-2">
					...
					<textarea name="aciklama" class="editor"></textarea>
				</div>
     	...
     	<button type="submit" class="btn btn-dark py-2 my-4 px-4 font-weight-bold">
...
$(function(){
	...
	//proje Ekle --------------------------------------------------------------
    $("#projeEkleForm").submit(function(e){
        e.preventDefault();
		...
		if( $("select").hasClass("kategori-var") && $("[name=kategori_id]").val() < 1){
			Swal.fire({
                type: 'error', 
                text: 'Lütfen projenin kategorisini seçin',
            ...
            Swal.fire({
                type: 'error', 
                text: 'Lütfen proje adını yazınız',
                confirmButtonText: 'Tamam',
                confirmButtonColor: '#333'
            }).then(function(){
            ...
            $.ajax({
                type        : "post",
                url         : "{{ route('panel.proje.ekle.post') }}",
                data        : form_data,
                contentType : false,            
                processData : false,            
                dataType    :'json',
